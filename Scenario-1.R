if (plot_out == 1) pdf("Plots-Scenario-1.pdf")
...
JuliaCall::julia_assign("p", c(p2[1], 1000, p2[1], 1001, p2[1], 1002, p2[1], 1003, p2[1], 1004, p2[1], 1005, p2[1], 1006, p2[1], 1007, p2[1], 1008, p2[1], 1009, p2[1], 1010, p2[1]))
